        ...
        <div className="overflow-hidden pb-5 pt-20 sm:pb-10 sm:pt-32 relative">
            ...
            <div className="flex flex-col my-10">
                ...
                <ul className="w-9/12 mx-auto">
                    <li className="list-item list-['=>']"> Digital: Automated alerts and calls on overdue repayments</li>
                    <li className="list-item list-['=>']"> In person follow-up: borrower and guarantor</li>
                    <li className="list-item list-['=>']"> Win-win fee structure: No collection, no fee</li>
                </ul>
            </div>

            <div className="absolute bottom-0  z-0 opacity-10">
