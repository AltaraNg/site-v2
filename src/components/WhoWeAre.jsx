...
const features = [
    {
        title: "Debt recovery ",
        description: "Assist clients with customers and guarantors follow-up",
        image: L1,
    },
    {
        title: "Customer Re-engagement AS",
        description: " Provide contact tracing services. Ensure the location and contact information of lost clients.",
        image: L3,
    },
    {
        title: "Portfolio Recovery Analytics AS",
        description: " Real-time analytics of overdue and non-performing loans + data supporting repayment risk.",
        image: L4,
    },
    {
