        ...
        <Container className="pb-16 pt-20 text-center">
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                ...
                <span className="relative whitespace-nowrap text-blue-600">
                    ...
                    <span className="relative">And Recovery</span>
                </span>{" "}
                with Altara.
            </h1>
            {/* <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 font-medium">
                Welcome to Altara, where financial empowerment meets convenience. Whether you're an individual looking for a loan or a business
