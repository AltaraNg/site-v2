    ...
    return (
        <SlimLayout>
            ...
            <form action="#" className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                ...
                <TextField className="col-span-full" label="Email address" name="email" type="email" autoComplete="email" required />
                <TextField className="col-span-full" label="Password" name="password" type="password" autoComplete="new-password" required />
